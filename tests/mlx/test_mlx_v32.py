...
class TestExtendedRoPE:
    ...
    def test_config_creation(self):
        ...
        from deepseek.mlx.attention import ExtendedRoPEConfig, RoPEScalingType
    ...
    def test_ntk_forward(self):
        ...
        from deepseek.mlx.attention import ExtendedRotaryPositionalEncoding, ExtendedRoPEConfig
    ...
    def test_yarn_forward(self):
        ...
        from deepseek.mlx.attention import (
...
class TestSparseAttention:
    ...
    def test_dsa_config(self):
        ...
        from deepseek.mlx.sparse_attention import DSAConfig
    ...
    def test_sparse_pattern_generation(self):
        ...
        from deepseek.mlx.sparse_attention import DSAConfig, SparseAttentionPattern
    ...
    def test_dsa_forward(self):
        ...
        from deepseek.mlx.sparse_attention import DSAConfig, DeepSeekSparseAttention
    ...
    def test_block_sparse_attention(self):
        ...
        from deepseek.mlx.sparse_attention import DSAConfig, BlockSparseAttention
...
class TestMoEV3:
    ...
    def test_moe_v3_config(self):
        ...
        from deepseek.mlx.moe import DeepSeekMoEV3Config
    ...
    def test_load_balancing_state(self):
        ...
        from deepseek.mlx.moe import DeepSeekMoEV3Config, LoadBalancingState
    ...
    def test_moe_v3_forward(self):
        ...
        from deepseek.mlx.moe import DeepSeekMoEV3Config, DeepSeekMoEV3
...
class TestDualPipe:
    ...
    def test_dualpipe_creation(self):
        ...
        from deepseek.mlx.pipeline import DualPipeScheduler, DualPipePhase
    ...
    def test_dualpipe_schedule(self):
        ...
        from deepseek.mlx.pipeline import DualPipeScheduler
...
class TestDSAAlignmentLoss:
    ...
    def test_mse_loss(self):
        ...
        from deepseek.mlx.pipeline import DSAAlignmentLoss, DSAAlignmentConfig, DSAAlignmentLossType
    ...
    def test_sampled_loss(self):
        ...
        from deepseek.mlx.pipeline import DSAAlignmentLoss, DSAAlignmentConfig
...
class TestCapacityMetrics:
    ...
    def test_capacity_metrics_creation(self):
        ...
        from deepseek.mlx.moe import CapacityMetrics
...
class TestActivationCheckpointing:
    ...
    def test_checkpointing_none(self):
        ...
        from deepseek.mlx.pipeline import ActivationCheckpointing, CheckpointingStrategy
    ...
    def test_checkpointing_optimal(self):
        ...
        from deepseek.mlx.pipeline import ActivationCheckpointing
...
class TestZeROOptimizer:
    ...
    def test_zero_stage0(self):
        """Test ZeRO Stage 0."""
        from deepseek.mlx.pipeline import ZeROOptimizer, ZeROStage
...
class TestHierarchicalAllToAll:
    ...
    def test_node_topology(self):
        ...
        from deepseek.mlx.pipeline import HierarchicalAllToAll
...
class TestFP8Format:
    ...
    def test_fp8_format_constants(self):
        ...
        from deepseek.mlx.quantization import (
    ...
    def test_tile_scaling_config(self):
        ...
        from deepseek.mlx.quantization import TileScalingConfig, FP8Format
...
class TestTileScaling:
    ...
    def test_compute_tile_scales(self):
        ...
        from deepseek.mlx.quantization import TileScalingConfig, TileScalingState, FP8Format
...
class TestFP8OptimizerState:
    ...
    def test_optimizer_state_creation(self):
        ...
        from deepseek.mlx.quantization import FP8OptimizerState, FP8OptimizerConfig
...
class TestFP8MixedPrecisionManager:
    ...
    def test_manager_creation(self):
        ...
        from deepseek.mlx.quantization import FP8MixedPrecisionManager, FP8TrainingConfig
...
class TestFP8Linear:
    ...
    def test_fp8_linear_creation(self):
        ...
        from deepseek.mlx.quantization import FP8Linear
...
class TestMLXToolCallFormat:
    ...
    def test_tool_call_creation(self):
        ...
        from deepseek.mlx.agent import ToolCall, ToolType
    ...
    def test_tool_response_creation(self):
        ...
        from deepseek.mlx.agent import ToolResponse, ToolStatus
...
class TestMLXAgentTrajectory:
    ...
    def test_trajectory_creation(self):
        ...
        from deepseek.mlx.agent import AgentTrajectory, TaskTier
    ...
    def test_trajectory_with_steps(self):
        ...
        from deepseek.mlx.agent import (
...
class TestMLXTaskTiers:
    ...
    def test_tier_expected_calls(self):
        ...
        from deepseek.mlx.agent import TaskTier
...
class TestMLXRewardComputation:
    ...
    def test_reward_weights(self):
        ...
        from deepseek.mlx.agent import RewardWeights
    ...
    def test_reward_breakdown(self):
        ...
        from deepseek.mlx.agent import AgentRewardComputer, AgentTrajectory, TaskTier
...
class TestMLXTaskGenerator:
    ...
    def test_generator_creation(self):
        ...
        from deepseek.mlx.agent import TaskGenerator
    ...
    def test_generate_single_task(self):
        ...
        from deepseek.mlx.agent import TaskGenerator, TaskTier
...
class TestMLXToolCallParser:
    ...
    def test_parse_json_code_block(self):
        ...
        from deepseek.mlx.agent import ToolCallParser, ToolType
    ...
    def test_parse_multiple_calls(self):
        ...
        from deepseek.mlx.agent import ToolCallParser
...
class TestMLXAgentGRPOTrainer:
    ...
    def test_trainer_creation(self):
        ...
        from deepseek.mlx.agent import AgentGRPOTrainer, AgentGRPOConfig
    ...
    def test_curriculum_update(self):
        ...
        from deepseek.mlx.agent import AgentGRPOTrainer, AgentGRPOConfig, TaskTier
...
class TestMLXAgentEnvironment:
    ...
    def test_environment_creation(self):
        ...
        from deepseek.mlx.agent import AgentEnvironment
...
class TestMLXAgentGroupSampler:
    ...
    def test_sampler_creation(self):
        ...
        from deepseek.mlx.agent import AgentGroupSampler
    ...
    def test_sample_group(self):
        ...
        from deepseek.mlx.agent import AgentGroupSampler, TaskTier
