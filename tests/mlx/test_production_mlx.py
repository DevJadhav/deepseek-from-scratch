"""
DeepSeek-V3.2 Production Hardening Tests for MLX
...
# Add src to path for deepseek imports
...
class TestLongContextMLX:
    ...
    def test_rope_128k_initialization(self):
        ...
        skip_if_no_mlx()
        from deepseek.mlx.attention import ExtendedRoPEConfig, ExtendedRotaryPositionalEncoding, RoPEScalingType
    ...
    def test_rope_all_scaling_types(self):
        ...
        scaling_types = [
            ...
            (RoPEScalingType.NTK_AWARE, {"ntk_alpha": 32.0}),
            (RoPEScalingType.YARN, {"original_max_seq_len": 4096}),
        ]
        ...
        for scaling_type, kwargs in scaling_types:
            ...
            # Test with input shape [batch, heads, seq, head_dim]
            x = mx.random.normal((1, 4, 32, 64))
            out = rope(x)
            
            assert out.shape == x.shape
            print(f"  ✓ MLX RoPE {scaling_type.value} scaling passed")
...
class TestKVCacheMLX:
    ...
    def test_kv_cache_creation_mlx(self):
        ...
        skip_if_no_mlx()
        from deepseek.mlx.attention import KVCache
...
class TestSpeculativeDecodingMLX:
    ...
    def test_mtp_model_forward_mlx(self):
        ...
        skip_if_no_mlx()
        from deepseek.mlx.mtp import MTPConfig, MTPModel
        ...
        assert main_logits.shape[0] == batch
        assert main_logits.shape[1] == seq
        assert len(future_logits) == config.prediction_depth
...
class TestAgentPipelineMLX:
    ...
    def test_agent_trajectory_workflow_mlx(self):
        ...
        action1 = AgentAction(
            ...
            content="Searching for sort algorithm",
            tool_call=ToolCall(
                id="call_1",
    ...
    def test_reward_computation_mlx(self):
        ...
        skip_if_no_mlx()
        from deepseek.mlx.agent import RewardWeights, RewardBreakdown
        ...
        # Compute the weighted total manually since breakdown.total is a float attribute
        reward = (
...
class TestEndToEndGenerationMLX:
    ...
    def test_multi_layer_generation_mlx(self):
        ...
        for _ in range(n_layers):
            ...
            moes.append(DeepSeekMoEV3(moe_config))
