...
class TestExtendedRoPE:
    ...
    def test_config_creation(self):
        ...
        from deepseek.torch.model.mla import ExtendedRoPEConfig
    ...
    def test_ntk_forward(self):
        ...
        from deepseek.torch.model.mla import ExtendedRoPEConfig, ExtendedRotaryPositionalEncoding
...
class TestSparseAttention:
    ...
    def test_dsa_config(self):
        ...
        from deepseek.torch.model.sparse_attention import DSAConfig
    ...
    def test_sparse_pattern_generation(self):
        ...
        from deepseek.torch.model.sparse_attention import DSAConfig, SparseAttentionPattern
    ...
    def test_dsa_forward(self):
        ...
        from deepseek.torch.model.sparse_attention import DSAConfig, DeepSeekSparseAttention
    ...
    def test_block_sparse_attention(self):
        ...
        from deepseek.torch.model.sparse_attention import DSAConfig, BlockSparseAttention
...
class TestMoEV3:
    ...
    def test_load_balancing_state(self):
        ...
        from deepseek.torch.model.moe import DeepSeekMoEV3Config, LoadBalancingState
    ...
    def test_moe_v3_forward(self):
        ...
        from deepseek.torch.model.moe import DeepSeekMoEV3Config, DeepSeekMoEV3
...
class TestDualPipe:
    ...
    def test_dualpipe_creation(self):
        ...
        from deepseek.torch.training.pipeline import DualPipeScheduler
    ...
    def test_dualpipe_schedule(self):
        ...
        from deepseek.torch.training.pipeline import DualPipeScheduler, DualPipePhase
...
class TestDSAAlignmentLoss:
    ...
    def test_mse_loss(self):
        ...
        from deepseek.torch.training.training import DSAAlignmentLoss
...
class TestCapacityMetrics:
    ...
    def test_capacity_metrics_record_dispatch(self):
        ...
        # Expert 0: 100 routed, 80 capacity -> 20 dropped, 80 processed
        metrics.record_dispatch(expert_id=0, tokens_routed=100, capacity=80)
        
        # total_tokens tracks all tokens routed (100), not just processed
        assert metrics.total_tokens == 100
        assert metrics.dropped_tokens == 20
        assert metrics.processed_tokens == 80
...
class TestActivationCheckpointing:
    ...
    def test_checkpointing_none(self):
        ...
        from deepseek.torch.training.pipeline import (
    ...
    def test_checkpointing_optimal(self):
        ...
        from deepseek.torch.training.pipeline import ActivationCheckpointing
...
class TestZeROOptimizer:
    ...
    def test_zero_stage0(self):
        ...
        from deepseek.torch.training.pipeline import ZeROOptimizer, ZeROStage
...
class TestHierarchicalAllToAll:
    ...
    def test_node_topology(self):
        ...
        from deepseek.torch.training.pipeline import HierarchicalAllToAll
...
class TestToolCallFormat:
    ...
    def test_tool_call_creation(self):
        ...
        from deepseek.torch.training.agent import ToolCall, ToolType
    ...
    def test_tool_response_creation(self):
        ...
        from deepseek.torch.training.agent import ToolResponse, ToolStatus
...
class TestAgentTrajectory:
    ...
    def test_trajectory_creation(self):
        ...
        from deepseek.torch.training.agent import (
...
class TestTaskTiers:
    ...
    def test_tier_expected_calls(self):
        ...
        from deepseek.torch.training.agent import TaskTier
...
class TestRewardComputation:
    ...
    def test_reward_weights(self):
        ...
        from deepseek.torch.training.agent import RewardWeights
...
class TestTaskGenerator:
    ...
    def test_generator_creation(self):
        ...
        from deepseek.torch.training.agent import TaskGenerator
    ...
    def test_generate_single_task(self):
        ...
        from deepseek.torch.training.agent import TaskGenerator, TaskTier
...
class TestToolCallParser:
    ...
    def test_parse_json_code_block(self):
        ...
        from deepseek.torch.training.agent import ToolCallParser, ToolType
    ...
    def test_parse_multiple_calls(self):
        ...
        from deepseek.torch.training.agent import ToolCallParser
...
class TestAgentGRPOTrainer:
    ...
    def test_trainer_creation(self):
        ...
        from deepseek.torch.training.agent import AgentGRPOTrainer, AgentGRPOConfig
    ...
    def test_curriculum_update(self):
        ...
        from deepseek.torch.training.agent import AgentGRPOTrainer, AgentGRPOConfig, TaskTier
...
class TestAgentEnvironment:
    ...
    def test_environment_creation(self):
        ...
        from deepseek.torch.training.agent import AgentEnvironment
...
class TestAgentGroupSampler:
    ...
    def test_sampler_creation(self):
        ...
        from deepseek.torch.training.agent import AgentGroupSampler
    ...
    def test_sample_group(self):
        ...
        from deepseek.torch.training.agent import AgentGroupSampler, TaskTier
