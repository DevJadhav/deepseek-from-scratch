...
from deepseek.cloud.modal.app import (
    GPU_CONFIG,
    RETRY_POLICY,
    app,
    checkpoints_volume,
...
from deepseek.cloud.modal.config import ModalConfig, Parallelism5DConfig, get_5d_config
...
def run_distributed_training(
    ...
    if config_path and Path(config_path).exists():
        ...
        from deepseek.pipeline.config import Backend, ModelSize, PipelineConfig
