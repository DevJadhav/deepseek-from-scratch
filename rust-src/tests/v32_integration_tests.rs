...
#[ignore] // Heavy computation (512 seq_len) - run on GPU: cargo test test_dsa_sliding_window_at_scale -- --ignored
#[test]
...
#[ignore] // Heavy: 256 experts - run with: cargo test test_moe_256_expert_routing -- --ignored
#[test]
...
#[ignore] // Heavy: capacity test - run with: cargo test test_moe_expert_capacity_overflow -- --ignored
#[test]
...
#[ignore] // Heavy: 64 experts hierarchical - run with: cargo test test_moe_hierarchical_routing -- --ignored
#[test]
...
#[ignore] // Heavy: attention comparison - run with: cargo test test_dsa_vs_dense_attention_divergence -- --ignored
#[test]
...
#[ignore] // Heavy: KV cache operations - run with: cargo test test_kv_cache_incremental_generation -- --ignored
#[test]
...
#[ignore] // Heavy: 128K allocation - run with: cargo test test_kv_cache_memory_efficiency -- --ignored
#[test]
...
#[ignore] // Heavy: full pipeline - run with: cargo test test_full_v32_forward_pipeline -- --ignored
#[test]
...
#[ignore] // Heavy: 5 iterations - run with: cargo test test_pipeline_numerical_stability -- --ignored
#[test]
...
#[ignore] // Benchmark - run with: cargo test benchmark_dsa_scaling -- --ignored
#[test]
...
#[ignore] // Benchmark - run with: cargo test benchmark_moe_expert_scaling -- --ignored
#[test]
...
#[ignore] // Heavy: e2e generation - run with: cargo test test_end_to_end_v32_generation -- --ignored
#[test]
